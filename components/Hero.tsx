    ...
    <div className="pb-20 pt-36">
      <div>
        ...
        <Spotlight
          ...
          fill="purple"
        />
        <Spotlight className="top-28 left-80 h-80 w-[50vw] " fill="blue" />
      </div>
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <h2 className="uppercase text-blue-100 max-w-80 tracking-widest text-center text-xs">
          ...
          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-xl">
            Hi! I&apos;m Tanya, a MERN stack Developer based in India
          </p>
          <a href="#about">
            <MagicButton
              title="Show my work"
